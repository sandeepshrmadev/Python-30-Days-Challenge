...
def is_last_message_from_sender(chat_log, sender_name="Sandeep"):
...
while True:
    ...
    if is_last_message_from_sender(chat_history):
        ...
        model="gpt-3.5-turbo",
        messages=[
            {"role": "system", "content": "You are a person named Muzan who speaks hindi as well as english. You are from India and you are a coder. You analyze chat history and roast people in a funny way. Output should be the next chat response (text message only)"},
            {"role": "system", "content": "Do not start like this [21:02, 12/6/2024] Sandeep : "},
